...
### 4. Plano de Testes Complementares — aguardar autorização

Antes de escrever qualquer teste, exiba o plano ao dev:

```
Testes complementares a criar:
• [nome do teste] — [cenário que cobre]
• [nome do teste] — [cenário que cobre]
```

Pergunte: *"Os testes complementares listados estão corretos? Posso criá-los? (sim/não)"*

Só escreva os testes após resposta explícita. Se o dev ajustar a lista → revise e confirme.

### 5. Escrever Testes Complementares
