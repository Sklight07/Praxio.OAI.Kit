...
Leia `.oai-kit/policies/release-policy.md`:
...
1. Acione o oai-kit-learning-agent.
...
- Nunca pule o oai-kit-learning-agent — o Speckit deve ser atualizado em todo ciclo.
