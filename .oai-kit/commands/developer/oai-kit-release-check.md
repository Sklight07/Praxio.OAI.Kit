...
**Uso:** `/oai-kit-release-check {ID_AZURE_TASK}`

## Sequência de Execução

### PASSO 1 — Invocar oai-kit-release-agent

O agente `oai-kit-release-agent`:
- Verifica PR aprovado e pipeline de CI verde no Azure DevOps
- Verifica janela e freeze periods da release-policy em `.oai-kit/policies/release-policy.md`
...
1. Acione `oai-kit-learning-agent` → Speckit atualizado.
