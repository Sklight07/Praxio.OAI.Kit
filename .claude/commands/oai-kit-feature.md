...
O `oai-kit-builder-agent` para cada task:
...
O `oai-kit-pr-generator` cria o PR com título e descrição no padrão Praxio e preenche a task de fechamento de desenvolvimento no Azure.
