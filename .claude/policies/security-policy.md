...
Verificações obrigatórias do `builder-agent` e `architecture-agent`. Violações são hard stops.
...
## Verificações do Architecture-Agent

Antes de aprovar qualquer fix, o `architecture-agent` executa Grep por:
